...
namespace Geometry {
    ...
    constexpr CuboidFeature cuboidFacefromNeighbourRelation(Geometry::NeighbourRelation relation) {
        switch (relation) {
    ...
    public:
        ...
        static std::array<bool, 26> should_send(const std::array<std::size_t, 26> &neighbour_ranks, std::size_t rank) {
            ...
            for (auto &neighbour: NeighbourEnumIterable) {
        ...
        should_send(NeighbourRelation relation, const std::array<std::size_t, 26> &neighbour_ranks, std::size_t my_rank) {
